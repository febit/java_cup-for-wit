...
public class lalr_item_set {
  ...
  /** Access to iterator elements of the set. */
   ...
   */
  public boolean is_subset_of(lalr_item_set other) throws InternalException
    {
      not_null(other);
   ...
   * @param other the other set in question.
   */
  public boolean is_superset_of(lalr_item_set other) throws InternalException
    {
      not_null(other);
   ...
   */
  public lalr_item add(lalr_item itm) throws InternalException
    {
      lalr_item other;
   ...
   */
  public void remove(lalr_item itm) throws InternalException
    {
      not_null(itm); 
   ...
   */
  public void add(lalr_item_set other) throws InternalException
    {
      not_null(other);
   ...
   */
  public void remove(lalr_item_set other) throws InternalException
    {
      not_null(other);
  ...
  public lalr_item get_one() throws InternalException
    {
      Enumeration the_set;
      lalr_item result;
   ...
   */
  protected void not_null(Object obj) throws InternalException
    {
      if (obj == null) 
	throw new InternalException("Null object used in set operation");
    }
   ...
   *  assumes that nullability and first sets have been computed for iterator 
  ...
  public int hashCode()
      ...
      if (hashcode_cache == null)
	{
	  ...
	  //   we're not allowed (by contract) to do.  So hash them iterator.
