...
public class lalr_transition {
  ...
  public lalr_transition(symbol on_sym, lalr_state to_st, lalr_transition nxt)
    throws InternalException
    {
      /* sanity checks */
      if (on_sym == null)
	throw new InternalException("Attempt to create transition on null symbol");
      if (to_st == null)
	throw new InternalException("Attempt to create transition to null state");
   ...
   * @param to_st   state we transition to.
   */
  public lalr_transition(symbol on_sym, lalr_state to_st) throws InternalException
    {
