...
/** CUP v0.12zqq 20130720 generated parser.
  * @version Fri Jul 26 00:07:10 CST 2013
  */
...
"spec","package_spec","import_list","action_code_part","code_parts","code_part","opt_semi","non_terminal","parser_code_part","symbol_list",
"start_spec","production_list","multipart_id","import_spec","import_id","init_code","scan_code","symbol","type_id","term_name_list",
"non_term_name_list","production","prod_part_list","prod_part","new_term_id","new_non_term_id","rhs_list","rhs","empty","precedence_list",
"preced","terminal_list","precedence_l","declares_term","declares_non_term","nt_id","symbol_id","label_id","opt_label","terminal_id",
"term_id","robust_id","typearglist","typearguement","wildcard","NT$0","NT$1","NT$2","NT$3","NT$4",
"NT$5","NT$6","NT$7","NT$8","NT$9","NT$10","NT$11","NT$12","NT$13"
  };
  ...
  protected java_cup.runtime.Symbol scan()
    throws Exception
    {
...
class CUP$Parser$actions {
  ...
  protected ProductionPart add_lab(ProductionPart part, String lab)
    throws InternalException
    {
      ...
      return new SymbolPart(((SymbolPart)part).the_symbol(),lab);
    }
  ...
  protected ProductionPart[] rhs_parts = new ProductionPart[MAX_RHS];
  ...
  protected void add_rhs_part(ProductionPart part) throws java.lang.Exception
    {
      if (rhs_pos >= MAX_RHS)
  ...
  protected Stack multipart_names = new ArrayStack();
...
// TUM CHANGES
  ...
  protected NonTerminal start_nt = null;
  ...
  protected final Object CUP$Parser$do_action(
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol start_val$Symbol = CUP$Parser$stack.peek(1);
		Object start_val = (Object) start_val$Symbol.value;
		RESULT = start_val;
		/* ACCEPT */
	...
	case 2: // spec ::= NT$0 package_spec import_list code_parts symbol_list precedence_list start_spec production_list 
	{
		...
		RESULT = (Object) CUP$Parser$stack.peek(7).value;
	...
	case 5: // package_spec ::= PACKAGE multipart_id NT$1 SEMI 
	{
		...
		RESULT = (Object) CUP$Parser$stack.peek(1).value;
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol user_code$Symbol = CUP$Parser$stack.peek(1);
		String user_code = (String) user_code$Symbol.value;
	...
	case 44: // preced ::= PRECEDENCE LEFT NT$7 terminal_list SEMI 
	{
		...
		RESULT = (Object) CUP$Parser$stack.peek(2).value;
	...
	{
		String RESULT =null;
		java_cup.runtime.Symbol sym$Symbol = CUP$Parser$stack.peek(0);
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol start_name$Symbol = CUP$Parser$stack.peek(0);
		String start_name = (String) start_name$Symbol.value;
 
	  /* verify that the name has been declared as a non Terminal */
	  NonTerminal nt = (NonTerminal)non_terms.get(start_name);
	  if (nt == null)
	    {
          ...
          else
	    {
	      ...
	      add_rhs_part(new SymbolPart(Terminal.EOF));
	      add_rhs_part(new ActionPart("return myStack.peek(1).value;"));
	      Emit.start_production = 
		     new Production(NonTerminal.START_nt, rhs_parts, rhs_pos);
	      new_rhs();
	    }
	...
	case 54: // start_spec ::= START WITH nt_id NT$10 SEMI 
	{
		...
		RESULT = (Object) CUP$Parser$stack.peek(1).value;
		java_cup.runtime.Symbol start_name$Symbol = CUP$Parser$stack.peek(2);
		String start_name = (String) start_name$Symbol.value;
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol lhs_id$Symbol = CUP$Parser$stack.peek(0);
		String lhs_id = (String) lhs_id$Symbol.value;

	  /* lookup the lhs nt */
	  lhs_nt = (NonTerminal)non_terms.get(lhs_id);
	...
	case 59: // production ::= nt_id NT$11 COLON_COLON_EQUALS rhs_list SEMI 
	{
		...
		RESULT = (Object) CUP$Parser$stack.peek(3).value;
		java_cup.runtime.Symbol lhs_id$Symbol = CUP$Parser$stack.peek(4);
		String lhs_id = (String) lhs_id$Symbol.value;
 ...
 ErrorManager.getManager().emit_error("Syntax Error"); 
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol term_name$Symbol = CUP$Parser$stack.peek(0);
		String term_name = (String) term_name$Symbol.value;
	  ...
	  if (lhs_nt != null) 
		...
		sym = ((SymbolPart)symbols.get(term_name)).the_symbol();
	      }
		...
		((SymbolPart)symbols.get(term_name)).the_symbol().note_use();
	      } else {
              ...
              if (start_nt == null)
		{
		  ...
		  if ((sym!=null) && (sym instanceof Terminal)) {
		    Emit.start_production = 
		      new Production(NonTerminal.START_nt, rhs_parts, 
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol symid$Symbol = CUP$Parser$stack.peek(1);
		String symid = (String) symid$Symbol.value;
		java_cup.runtime.Symbol labid$Symbol = CUP$Parser$stack.peek(0);
		String labid = (String) labid$Symbol.value;
		 
	  /* try to look up the id */
	  ProductionPart symb = (ProductionPart)symbols.get(symid);
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol code_str$Symbol = CUP$Parser$stack.peek(0);
		String code_str = (String) code_str$Symbol.value;
		 
	  /* add a new Production part */
	  add_rhs_part(new ActionPart(code_str));
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol another_id$Symbol = CUP$Parser$stack.peek(0);
		String another_id = (String) another_id$Symbol.value;
 ...
 multipart_names.push(multipart_name); multipart_name="";
	...
	case 74: // multipart_id ::= multipart_id NT$13 LT typearglist GT 
	{
		...
		RESULT = (Object) CUP$Parser$stack.peek(3).value;
		java_cup.runtime.Symbol types$Symbol = CUP$Parser$stack.peek(1);
		String types = (String) types$Symbol.value;
		 multipart_name =
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol an_id$Symbol = CUP$Parser$stack.peek(0);
		String an_id = (String) an_id$Symbol.value;
	...
	{
		String RESULT =null;
		java_cup.runtime.Symbol arg$Symbol = CUP$Parser$stack.peek(0);
		String arg = (String) arg$Symbol.value;
		 RESULT = arg; 
		return RESULT;
	}
	...
	{
		String RESULT =null;
		java_cup.runtime.Symbol list$Symbol = CUP$Parser$stack.peek(2);
		String list = (String) list$Symbol.value;
		java_cup.runtime.Symbol arg$Symbol = CUP$Parser$stack.peek(0);
		String arg = (String) arg$Symbol.value;
		 RESULT = list + "," + arg; 
		return RESULT;
	...
	{
		String RESULT =null;
		java_cup.runtime.Symbol w$Symbol = CUP$Parser$stack.peek(0);
		String w = (String) w$Symbol.value;
		 RESULT = w; 
		return RESULT;
	}
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol term_id$Symbol = CUP$Parser$stack.peek(0);
		String term_id = (String) term_id$Symbol.value;
	  ...
	  if (symbols.get(term_id) != null)
		...
		multipart_name = "Object";
	      ...
	      /* build a ProductionPart and put it in the table */ 
	      symbols.put(term_id, 
	        new SymbolPart(new Terminal(term_id, multipart_name)));
	    }
	...
	{
		Object RESULT =null;
		java_cup.runtime.Symbol non_term_id$Symbol = CUP$Parser$stack.peek(0);
		String non_term_id = (String) non_term_id$Symbol.value;
	  ...
	  if (symbols.get(non_term_id) != null)
	  ...
	  else
	    {
	      ...
	      /* build the non terminal object */
              NonTerminal this_nt = 
		new NonTerminal(non_term_id, multipart_name);

	      /* put it in the non_terms table */
	      non_terms.put(non_term_id, this_nt);

	      /* build a ProductionPart and put it in the symbols table */ 
	      symbols.put(non_term_id, new SymbolPart(this_nt));
	    }
	...
	{
		String RESULT =null;
		java_cup.runtime.Symbol the_id$Symbol = CUP$Parser$stack.peek(0);
		String the_id = (String) the_id$Symbol.value;
		 RESULT = the_id; 
		return RESULT;
	}
