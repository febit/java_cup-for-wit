 ...
 * in order to detect symbols that are declared but never used, and an id
 * number that indicates where it appears in parse tables (id numbers are
...
public abstract class symbol {
   ...
   *  however, a terminal may have the same id as a non-terminal, etc. 
   */
   protected int _id;
