...
public class ErrorManager{
    ...
    public void emit_fatal(String message, Symbol sym){
        //System.err.println("Fatal at ("+sym.line+"/"+sym.column+")@"+convSymbol(sym)+" : "+message);
...
//        System.err.println("Warning at ("+sym.line+"/"+sym.column+")@"+convSymbol(sym)+" : "+message);
        System.err.println("Fatal: "+message+" @ "+sym);
        warnings++;
    }
...
//        System.err.println("Error at ("+sym.line+"/"+sym.column+")@"+convSymbol(sym)+" : "+message);
