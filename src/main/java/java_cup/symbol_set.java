...
public class symbol_set {
   ...
   */
  public symbol_set(symbol_set other) throws InternalException
    {
      not_null(other);
   ...
   */
  public boolean is_subset_of(symbol_set other) throws InternalException
    {
      not_null(other);
   ...
   */
  public boolean is_superset_of(symbol_set other) throws InternalException
    {
      not_null(other);
   ...
   */
  public boolean add(symbol sym) throws InternalException
    {
      Object previous;
   ...
   */
  public void remove(symbol sym) throws InternalException
    {
      not_null(sym); 
   ...
   * @return true if this changes the set. 
   */
  public boolean add(symbol_set other) throws InternalException
    {
   ...
   */
  public void remove(symbol_set other) throws InternalException
    {
      not_null(other);
